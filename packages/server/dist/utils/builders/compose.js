...
import { writeDomainsToCompose } from "../docker/domain.js";
import { encodeBase64, getEnviromentVariablesObject, prepareEnvironmentVariables, } from "../docker/utils.js";
...
const getExportEnvCommand = (compose) => {
    if (compose.composeType !== "stack")
        return "";
    const envVars = getEnviromentVariablesObject(compose.env, compose.environment.project.env);
