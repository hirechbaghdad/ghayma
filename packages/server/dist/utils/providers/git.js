...
import { findSSHKeyById, updateSSHKeyById, } from "../../services/ssh-key.js";
import { execAsync, execAsyncRemote } from "../process/execAsync.js";
export const cloneGitRepository = async ({ type = "application", ...entity }) => {
    let command = "set -e;";
    const { appName, customGitUrl, customGitBranch, customGitSSHKeyId, enableSubmodules, serverId, } = entity;
