...
export const getContainers = async (serverId) => {
    try {
        const command = "docker ps -a --format 'CONTAINER ID : {{.ID}} | Name: {{.Names}} | Image: {{.Image}} | Ports: {{.Ports}} | State: {{.State}} | Status: {{.Status}}'";
        let stdout = "";
        let stderr = "";
        if (serverId) {
...
export const getConfig = async (containerId, serverId) => {
    try {
...
export const getContainersByAppNameMatch = async (appName, appType, serverId) => {
    try {
        let result = [];
        const cmd = "docker ps -a --format 'CONTAINER ID : {{.ID}} | Name: {{.Names}} | State: {{.State}}'";
        const command = appType === "docker-compose"
...
export const getStackContainersByAppName = async (appName, serverId) => {
    try {
        let result = [];
...
export const getServiceContainersByAppName = async (appName, serverId) => {
    try {
        let result = [];
...
export const getContainersByAppLabel = async (appName, type, serverId) => {
    try {
        let stdout = "";
        let stderr = "";
        const command = type === "swarm"
...
export const containerRestart = async (containerId) => {
    try {
        const { stdout, stderr } = await execAsync(`docker container restart ${containerId}`);
        if (stderr) {
            console.error(`Error: ${stderr}`);
            return;
        }
...
export const getSwarmNodes = async (serverId) => {
    try {
        let stdout = "";
        let stderr = "";
...
export const getNodeInfo = async (nodeId, serverId) => {
    try {
...
export const getNodeApplications = async (serverId) => {
    try {
        let stdout = "";
        let stderr = "";
...
export const getApplicationInfo = async (appNames, serverId) => {
    try {
        let stdout = "";
        let stderr = "";
