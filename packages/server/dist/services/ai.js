...
import { ai } from "../db/schema/index.js";
import { selectAIProvider } from "../utils/ai/select-ai-provider.js";
import { TRPCError } from "@trpc/server";
import { generateObject } from "ai";
import { desc, eq } from "drizzle-orm";
import { z } from "zod";
import { IS_CLOUD } from "../constants/index.js";
import { findOrganizationById } from "./admin.js";
import { findServerById } from "./server.js";
export const getAiSettingsByOrganizationId = async (organizationId) => {
...
export const getAiSettingById = async (aiId) => {
...
export const saveAiSettings = async (organizationId, settings) => {
...
export const deleteAiSettings = async (aiId) => {
    return db.delete(ai).where(eq(ai.aiId, aiId));
};
export const suggestVariants = async ({ organizationId, aiId, input, serverId, }) => {
    try {
