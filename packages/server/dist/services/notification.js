...
import { discord, email, lark, gotify, notifications, ntfy, slack, telegram, } from "../db/schema/index.js";
...
export const updateSlackNotification = async (input) => {
    await db.transaction(async (tx) => {
        const newDestination = await tx
...
export const createTelegramNotification = async (input, organizationId) => {
    await db.transaction(async (tx) => {
...
export const updateTelegramNotification = async (input) => {
    await db.transaction(async (tx) => {
        const newDestination = await tx
            .update(notifications)
            .set({
...
export const createDiscordNotification = async (input, organizationId) => {
    await db.transaction(async (tx) => {
...
export const updateDiscordNotification = async (input) => {
    await db.transaction(async (tx) => {
        const newDestination = await tx
            .update(notifications)
            .set({
...
export const updateEmailNotification = async (input) => {
    await db.transaction(async (tx) => {
        const newDestination = await tx
            .update(notifications)
            .set({
...
export const createGotifyNotification = async (input, organizationId) => {
    await db.transaction(async (tx) => {
...
export const updateGotifyNotification = async (input) => {
    await db.transaction(async (tx) => {
        const newDestination = await tx
            .update(notifications)
            .set({
...
export const createNtfyNotification = async (input, organizationId) => {
    await db.transaction(async (tx) => {
...
export const updateNtfyNotification = async (input) => {
    await db.transaction(async (tx) => {
        const newDestination = await tx
            .update(notifications)
            .set({
...
export const createLarkNotification = async (input, organizationId) => {
    await db.transaction(async (tx) => {
...
export const updateLarkNotification = async (input) => {
    await db.transaction(async (tx) => {
        const newDestination = await tx
            .update(notifications)
            .set({
...
export const updateNotificationById = async (notificationId, notificationData) => {
    const result = await db
        .update(notifications)
        .set({
        ...notificationData,
