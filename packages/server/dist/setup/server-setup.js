...
import { createServerDeployment, updateDeploymentStatus, } from "../services/deployment.js";
import { findServerById } from "../services/server.js";
import { getDefaultMiddlewares, getDefaultServerTraefikConfig, TRAEFIK_HTTP3_PORT, TRAEFIK_PORT, TRAEFIK_SSL_PORT, TRAEFIK_VERSION, } from "../setup/traefik-setup.js";
import slug from "slugify";
import { Client } from "ssh2";
import { recreateDirectory } from "../utils/filesystem/directory.js";
    ...
    return new Promise((resolve, reject) => {
        client
            ...
            if (err.level === "client-authentication") {
                onData?.(`Authentication failed: Invalid SSH private key. ❌ Error: ${err.message} ${err.level}`);
