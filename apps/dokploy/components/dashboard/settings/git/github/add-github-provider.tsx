		...
		const manifest = JSON.stringify(
			{
				...
				name: `Atlanexis-CloudOS-${format(new Date(), "yyyy-MM-dd")}-${randomString()}`,
				url: origin,
				hook_attributes: {
					...
					<CardContent className="p-0">
						<div className="flex flex-col ">
							<p className="text-muted-foreground text-sm">
								This connector requires you to create a Github APP, it will take only few minutes to authenticate, from there you will use your Github to deploy applications and services directly.
							</p>
