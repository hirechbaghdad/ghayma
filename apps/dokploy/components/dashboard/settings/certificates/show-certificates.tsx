			...
			<Card className="h-full bg-sidebar  p-2.5 rounded-xl  max-w-5xl mx-auto">
				<div className="rounded-xl bg-background shadow-md ">
					<CardHeader className="">
						...
						<CardDescription>
							Create certificates in the Dynamic Routing directory
						</CardDescription>

						<AlertBlock type="warning">
							Certificates are created in the Dynamic Routing directory. Dynamic Routing uses
							these certificates to secure your applications. Using invalid
							certificates can break your Dynamic Routing instance, preventing access to
							your applications.
						</AlertBlock>
					</CardHeader>
