				...
				<div className="rounded-xl bg-background shadow-md ">
					<CardHeader className="flex flex-row gap-2 justify-between w-full items-center flex-wrap">
						<div className="flex flex-col gap-2">
							...
							<CardDescription>Add nodes to your Distributed workload</CardDescription>
						</div>
							...
							<div className="flex flex-col items-center gap-3">
								...
								<div className="flex flex-row gap-2">
									<span className="text-base text-muted-foreground ">
										To add nodes to your Distributed Workload, you need to configure at least
										one registry.
									</span>
								...
								<ul className="list-disc list-inside text-sm text-muted-foreground border p-4 rounded-lg flex flex-col gap-1.5 mt-2.5">
									<li>
										<strong>Containers Registry:</strong> Use custom registries like
										Docker Hub, DigitalOcean Registry, Atlanexis Registry, and more...
									</li>
								</ul>
							</div>
						)}
