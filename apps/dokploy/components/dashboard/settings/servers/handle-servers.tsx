			...
			<DialogContent className="sm:max-w-3xl ">
				...
				<div>
					<p className="text-primary text-sm font-medium">
						You can build a hybrid cloud by adding different servers from AWS, Azure, GCP, Alibaba Cloud, Digital Ocean, and or other providers to build your hybrid cloud architecture.
					</p>
					<AlertBlock className="mt-4 px-4">
						Be advised, some of features may be missing or not available for some providers.
					</AlertBlock>
				</div>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input placeholder="Atlanexis CloudOS Server" {...field} />
										</FormControl>
