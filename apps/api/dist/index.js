...
}, { event: "deployment/requested" }, async ({ event, step }) => {
...
app.post("/cancel-deployment", zValidator("json", cancelDeploymentSchema), async (c) => {
    const data = c.req.valid("json");
    ...
    try {
        ...
        const identifier = data.applicationType === "application"
