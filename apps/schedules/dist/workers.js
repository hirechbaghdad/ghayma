...
export const firstWorker = new Worker("backupQueue", async (job) => {
...
export const secondWorker = new Worker("backupQueue", async (job) => {
...
export const thirdWorker = new Worker("backupQueue", async (job) => {
